...
persona: "Technical Founder Building in Public"
industry: "startups"
difficulty: "beginner"
related_use_cases: ["task-automation", "reddit-monitoring", "project-reporting"]
...
sections:
  ...
  - type: metrics
    ...
    items:
      ...
      - label: "Schedule reliability"
        value: "99%+"
        source: "Internal beta data"
      - label: "Models for writing"
        value: "100+"
  - type: before_after
    before:
      summary: "Hours spent researching and writing every day"
      items:
    ...
    after:
      summary: "AI agent researches, writes, and delivers — every single day"
      items:
  ...
  - type: content
  - type: steps
    heading: "Set up your content pipeline"
    items:
      - title: "Define your voice"
        description: "Upload writing samples, brand guidelines, or topic preferences to your workspace. The agent reads these files before every article to match your tone, expertise areas, and audience."
      - title: "Set the schedule"
        description: "Pick your frequency: daily, weekdays only, weekly. Choose the time. The agent runs in the background on schedule — no manual trigger needed."
      - title: "Choose your sources"
        description: "Tell the agent where to research: Hacker News, Reddit, industry blogs, Twitter. Define focus areas: AI tools, developer productivity, startup funding, whatever matters to your audience."
      - title: "Review and publish"
        description: "Drafts appear in your workspace. Edit, adjust tone, and publish. One user keeps their daily routine under 10 minutes: skim the draft, tweak one paragraph, post."
  - type: faq
    heading: "Common questions about content automation"
    items:
      - question: "Will the content sound like me or like a robot?"
        answer: "Like you. The agent reads your writing samples and brand files before every article. One user uploads their past LinkedIn posts and blog articles — the agent matches their 'AI-optimistic, engineer perspective' tone consistently across 20+ daily articles."
      - question: "Can I write in languages other than English?"
        answer: "Yes. Users generate content in English, Russian, Spanish, and more. You can even switch languages mid-conversation or set a default in your workspace preferences."
      - question: "What if I don't like the output?"
        answer: "Edit it. Every draft is saved to your workspace as a file you can modify. You can also give feedback in the chat — 'make it shorter,' 'more optimistic,' 'focus on the practical implications' — and the agent adjusts."
      - question: "How current is the research?"
        answer: "Real-time. The agent uses web search to find content from the last 24-48 hours. Every article references current events and trending discussions — not recycled knowledge from training data."
      - question: "How does this compare to using ChatGPT for writing?"
        answer: "ChatGPT can write one article at a time when you ask it. LikeClaw runs on a schedule, reads your workspace files for context, researches current events via web search, and delivers without you lifting a finger. It is the difference between a tool and an assistant."
  - type: cta
    heading: "Your daily content, on autopilot"
    subheading: "Research, write, deliver — every day. Set it up once, publish forever."
---
